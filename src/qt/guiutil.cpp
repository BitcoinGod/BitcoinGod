...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a BitcoinGod address (e.g. %1)").arg(
...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("bitcoingod"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("bitcoingod://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "bitcoingod:");
    }
...
{
    QString ret = QString("bitcoingod:%1").arg(info.address);
    int paramCount = 0;
